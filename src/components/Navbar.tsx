...
export default function NavBar() {
    return (
        <>
            <Head>
                <title>GHD Nb → Py</title>
                <meta name="description" content="Convert Jupyter Notebook files to Python scripts." />
                <link rel="icon" href="/favicon.ico" />
            </Head>
            {/* Navbar */}
            <div className="flex h-22 md:h-28 w-full items-center justify-center">
                <div className="flex h-full w-full max-w-4xl items-center md:justify-between justify-around p-5 text-2xl text-white">
                    {/* Github svg */}
                    <div
                    ...
                    <div
                        className="cursor-pointer hidden md:block"
                    >
                        {/* <img src="favicon.webp" className='w-14' alt="GHD Logo" /> */}
                        <svg
                            className="w-9 h-9"
                            viewBox="0 0 38 38"
                            fill="none"
